const crawlReponse = `
  <body class="auth-no-skin ap-locale-en_US a-m-us a-aui_72554-c a-aui_a11y_2_750578-t2 a-aui_a11y_6_837773-t2 a-aui_a11y_sr_678508-t1 a-aui_amzn_img_959719-c a-aui_amzn_img_gate_959718-t1 a-aui_killswitch_csa_logger_372963-c a-aui_pci_risk_banner_210084-c a-aui_template_weblab_cache_333406-c a-aui_tnr_v2_180836-c">    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:131-9023473-3619252:1K05D00EPNZBV0KWX7KF$uedata=s:%2Fap%2Fuedata%3Fstaticb%26id%3D1K05D00EPNZBV0KWX7KF:0' alt="" onload="window.ue_sbl && window.ue_sbl();"/>
<script>
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "1K05D00EPNZBV0KWX7KF",
        'CacheDetection.Callback': window.ue && ue.reset,
        'LCP.elementDedup': 1,
        'lob': '0'
    });
    csa("Events")("setEntity", {
        page: {requestId: "1K05D00EPNZBV0KWX7KF", meaningful: "interactive"},
        session: {id: "131-9023473-3619252"}
    });
}
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 18804)</script><div id="a-page"><script type="a-state" data-a-state="{&quot;key&quot;:&quot;a-wlab-states&quot;}">{"AUI_A11Y_2_750578":"T2","AUI_A11Y_6_837773":"T2","AUI_AMZN_IMG_GATE_959718":"T1","AUI_A11Y_SR_678508":"T1"}</script>
...
<div class="a-section">
  <form id="ap_register_form" name="register" method="post" novalidate action="https://www.amazon.com/ap/register/131-9023473-3619252" class="ap_ango_default auth-validate-form-moa auth-real-time-validation">
    <input type="hidden" name="appActionToken" value="8YabntJtJIxUAvVfq8d4Uanj2Fj2FIMj3D" /><input type="hidden" name="appAction" value="REGISTER" />
    <input type="hidden" name="openid.return_to" value="ape:aHR0cHM6Ly93d3cuYW1hem9uLmNvbS9yZWdpc3RyaWVzP3JlZl89bmF2X3lhX3NpZ25pbiZyZWZfPW5hdl95YV9zaWduaW4=" />
    <input type="hidden" name="prevRID" value="ape:MUswNUQwMEVQTlpCVjBLV1g3S0Y=" />
    <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.PrdH0H9DRNuxaD914kbG4cdt58WPBQZZ5z3HKDjMr-jbBwDVx6sa_g.jCRqNBdKk7csI9Lf.UBk2NnNMrTdAotVg1NhpEveXumo4hmEIiQcGhphUh-C46a4ExTrqktUZRcc2ZkVpRQxs9aM1s3kUzkREEKPqkIVZuQMxQrhETK9Mzixp0ACaYvN07NIr6Diprek0mruWny-ZBo-yBVFAbL08j1uedS-PewV98wHBWBNcQkkeAqNtLPyt4xQMt0BffJYGumyUiFUfCVjo4lhTS6r-x5jI1xybjFCNYiB2QwURcrFvI97rgg4j1siw6LmhmySzbXbzln8L.rpAn4C1ix0vuyeTLvBmJNA" />
...
<div class="a-row a-spacing-base">
  ...
  <input type="text" maxlength="50" id="ap_customer_name" autocomplete="name" placeholder="First and last name" name="customerName" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" aria-describedby="ap_customer_name_context_message_section" aria-required="true"/>
...
</select><span tabindex="-1" id="auth-country-picker-container" class="a-button a-button-dropdown a-button-disabled" aria-hidden="true" aria-disabled="true"><span class="a-button-inner"><span class="a-button-text a-declarative" data-csa-c-func-deps="aui-da-a-dropdown-button" data-csa-c-type="widget" data-csa-interaction-events="click" data-action="a-dropdown-button" aria-hidden="true"><span class="a-dropdown-prompt">US +1</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span>
      </div>
      <div class="a-section a-spacing-none moa-single-claim-input-container">
        <span class="a-declarative" data-action="single_claim_handler" data-csa-c-type="widget" data-csa-c-func-deps="aui-da-single_claim_handler" data-single_claim_handler="{}" id="moa-single-claim-input-direction">
          <input type="email" maxlength="64" id="ap_email" autocomplete="email" name="email" tabindex="3" class="a-input-text a-span12 a-spacing-micro auth-required-field auth-require-claim-validation" data-validation-id="email" aria-describedby="ap_email_context_message_section" aria-required="true"/>
        </span>
        <div class="a-section country-picker aok-hidden">
          <span class="a-declarative" data-action="show-countries" data-csa-c-type="widget" data-csa-c-func-deps="aui-da-show-countries" data-show-countries="{}">
...
<div class="a-row a-spacing-base">
  ...
  <input type="password" maxlength="1024" id="ap_password_check" autocomplete="new-password" name="passwordCheck" tabindex="6" class="a-input-text a-span12 auth-required-field auth-require-fields-match" aria-describedby="ap_password_check_context_message_section" aria-required="true"/>
      ...
      <div id="mobileClaimDisclosureMessageRelaxed" class="a-section a-spacing-top-mini auth-inlined-information-message aok-hidden">
        To verify your number, we will send you a text message with a temporary code. Message and data rates may apply.
          ...
          <div class="a-section a-spacing-extra-large">
            <span id="auth-continue" class="a-button a-button-span12 a-button-primary auth-requires-verify-modal"><span class="a-button-inner"><input id="continue" tabindex="8" aria-describedby="legalTextRow" class="a-button-input" type="submit" aria-labelledby="auth-continue-announce"/><span id="auth-continue-announce" class="a-button-text" aria-hidden="true">
...
<div class="a-row">
    ...
    <div class="a-section a-spacing-base">
        <a id="ab-enhanced-registration-link" class="a-link-normal" href="https://www.amazon.com/business/register/org/landing?ref_=ap_altreg_ab">
        ...
        <div class="a-row">
          ...
          <a class="a-link-emphasis" href="/ap/signin?openid.pape.max_auth_age=0&amp;openid.return_to=https%3A%2F%2Fwww.amazon.com%2Fregistries%3Fref_%3Dnav_ya_signin%26ref_%3Dnav_ya_signin&amp;prevRID=1K05D00EPNZBV0KWX7KF&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.assoc_handle=usflex&amp;openid.mode=checkid_setup&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;pageId=usflex&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0">
            Sign in
          </a>
        </div>
    </div></div>
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:131-9023473-3619252:1K05D00EPNZBV0KWX7KF$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3D1K05D00EPNZBV0KWX7KF:0' alt=""/>
</noscript>
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 48896)</script></body>
`


export default crawlReponse;